      ...
      <div class="theater-create-info-section">
        <form action="index.php" method="POST">
          ...
          <div class="theater-create-info-seats">
            <div class="theater-create-info-screen-size-badge">Number of Seats:</div>
            <input type="text" class="form-control" name="max_seats" value="0" placeholder="Number of Seats" />
          </div>
          <?php
            if (isset($_SESSION["max_seats_error"]) && $_SESSION["max_seats_error"]) {
              $_SESSION["max_seats_error"] = false;
          ?>
          <div class="theater-create-info-seats" style="color:red;text-align:right;">Seats available must be greater than 0!</div>
          <?php
            }
          ?>
